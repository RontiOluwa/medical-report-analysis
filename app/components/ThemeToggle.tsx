...
// Reads the current theme from ThemeContext and calls toggle() on click.
// Renders a sun icon in dark mode (click to go light) and a moon icon in light mode.
...
export function ThemeToggle() {
    // Pull the current theme and toggle function from context.
